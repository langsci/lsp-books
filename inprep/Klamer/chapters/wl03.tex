...
\end{tabular}\enlargethispage{1em}% for footnote
...
{\scshape Kmg\ilt{Kamang}} & {\itshape fon} & {\itshape tam}\textsuperscript{2} & -- & {\itshape {}-mai} & {\itshape joku{\ng}}\\
...
{\scshape Wer\ilt{Wersing}} & -- & (\textit{ne})\textit{tamu}\textsuperscript{4} & {\itshape walar} & -- & {\itshape iruk}\\
\mybottomrule
\end{tabular*}
