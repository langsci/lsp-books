...
3\textsc{inal} & *ga- & *g- & {\itshape g-} & {\itshape g-} & {\itshape k-} & -- & --\\
...
\begin{sidewaystable}
\caption[Dubious consonant-final reconstructions in AP and beyond]{Dubious consonant-final reconstructions in AP and beyond\todo[inline]{ no data for `tooth' set available!}}
\label{tab:3:21} 
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}llllllll}
\mytoprule
...
Ki\ilt{Kui} & {\itshape eb} & -- & {\itshape ar} & {\itshape bat} & {\itshape {}-liber} & {\itshape tain}\\
...
Sar\ilt{Sar} (S\textsc{Sr}) & Robinson fieldnotes 2010\\
...
\stepcounter{footnote}\footnotetext{Online at http://www.fataluku.com}
\stepcounter{footnote}\footnotetext{Online at http://www.ling.hawaii.edu/ldtc/languages/makasae\_fatum/ and\par http://www.ling.hawaii.edu/ldtc/languages/makasae\_osor/.}
...
\end{tabular}
\todo{check whether \textsc{aln} or \textsc{alien} should be used}
\todo{check whether \textsc{inal} or \textsc{inln} should be used}
...
{\scshape Ku\ilt{Kula}} & -- & {\itshape atamu}\textsuperscript{3} & {\itshape wala{\ng}ka} & {\itshape magin} & {\itshape joka}\\
...
{\scshape Km\ilt{Kamang}} & -- & -- & {\itshape fe} & {\itshape isei} & {\itshape buk} ?`\textsuperscript{4} & {\itshape {}-nei}\\
