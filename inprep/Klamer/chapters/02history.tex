...
\author{Gary Holton \& Laura Robinson} % you can also use \and and \affiliation
...
The tree based on shared phonological innovations (Figure \ref{fig1}) differs in several ways from previous classifications based on lexicostatistics. In particular, while the eastern languages Sawila and Wersing form a subgroup, they do not constitute primary branches of pAP, as has been suggested in several previous classifications (cf. \citet{Wurm1982}; \citet{Lewis2009}). This tree has obvious geographic correlates, as shown in Figure \ref{fig2} below. 
...
\begin{figure}
%\includegraphics[width=\textwidth]{figures/Ch2HoltonRobinsonAPhistoryMKprooftmp-img4.png}
...
\mytopline
Gloss & \rm pAP & \rm Tw & \rm Nd & \rm Ke & \rm WP & \rm Bl & \rm Ad & \rm Kl & \rm Ki & \rm Ab & \rm Km & \rm Sw & \rm We\\
\midrule 
{`axe'{\tablenote}} & & & & & {bali{\ng}} & & {bali{\ng}} & & & {fali{\ng}} & {pali{\ng}} & &  \\
