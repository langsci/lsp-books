...
\gllllll  {\upshape W Pantar\ilt{Western Pantar}}    aname    gai    bla\\
  ...
  {\upshape Adang\ilt{Adang}}       nami    o-    bang\\
...
\gllllll
      ...
      {\upshape Adang\ilt{Adang}}          nami  o-  mi-  towo  {}-mi \\      
...
\glllll  {} 100    2    \textsc{add}    \textsc{rdp}\~{}1\\  
 {\upshape W Pantar\ilt{Western Pantar}:} ratu    alaku    wali     ye\~{}ye        \\
 {\upshape Teiwa\ilt{Teiwa}:}    ratu    raq    rug    nuk\~{}nuk      \\
 {\upshape Abui\ilt{Abui}:}     aisaha     ayoku    wal    nuk\~{}nukda      \\
 {\upshape Kamang\ilt{Kamang}:}   ataak     ok     waal    no\~{}nok     \\  
\z
...
\label{bkm:Ref342656818}
 ...
 {\upshape Kamang\ilt{Kamang} distributive\ist{distributive numerals} numeral formation}
\begin{tabular}{llll}            
\mytopline
...
\ea
\label{ex:8:1236}
{\upshape Reduplication\ist{reduplication} of base-5 numerals in Abui\ilt{Abui} and Kamang\ilt{Kamang}}\\
\begin{tabular}{lll}
\mytopline
