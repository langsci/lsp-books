...
The following sections describe how distributives\is{distributive numerals} are derived: the regular patterns are discussed in Section \ref{sec:8:Regulardistributive}, and the irregularities in Section \ref{sec:8:Irregulardistributive}.  Full paradigms of distributives\is{distributive numerals} in five languages of our sample are given in the Appendix.
...
Kamang\il{Kamang} has an irregular choice of reduplicative\is{reduplication} base. Compare the reduplicants\is{reduplication} (in bold-face) in the numerals `seven' to `nine' in \REF{ex:8:1236}. We see that Abui\il{Abui} reduplicates\is{reduplication} only the right-most numeral, resulting in word-internal reduplication\is{reduplication}, which is consistent with the regular distributive\is{distributive numerals} pattern in AP languages (Section \ref{sec:8:Regulardistributive}). By contrast, Kamang\il{Kamang} reduplicates\is{reduplication} the initial element \textit{wesing}. As main stress is on the final syllable of the numerals in Kamang\il{Kamang} just as it is in Abui\il{Abui}, we analyse this as a choice of reduplicative\is{reduplication} base in Kamang\il{Kamang} distributives\is{distributive numerals} which diverges from the overall pattern of AP languages. 
