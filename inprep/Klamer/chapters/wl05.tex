...
Abui\il{Abui} shares with Kamang\il{Kamang} ({\S} \ref{sect_kamang}) an elaborate distinction in generational levels, distinguishing three descending and four ascending generations, as shown in Table \ref{table_abui_terms}.
