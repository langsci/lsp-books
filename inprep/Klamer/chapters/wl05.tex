...
\caption[Adang sibling terminologies]{Adang\ilt{Adang} sibling terminologies ({\checkmark}=preferred, ?=acceptable, x=unacceptable)}
\label{tab:5:5}
\end{table}  
