...
\begin{figure}
\includegraphics[width=\textwidth]{ch7fig1.png}
...
{Western Timor} & {Uab Meto\ilt{Uab Meto}} {\ddag} & \textit{m}\textit{{\textepsilon}}\textit{se} & {\itshape nua} & {\itshape tenu} & {\itshape ha} & {\itshape nim} & \textit{n}\textit{{\textepsilon}} & {\itshape hitu} & \textit{fanu}{\ddag} & {\itshape seo /sio} & \textit{bo{\textglotstop}}\textit{{\textepsilon}}\textit{s}{\dag}\\
 & {Amarasi\ilt{Amarasi}} & {\itshape es} & {\itshape nua} & {\itshape teun{\Tilde}tenu} & {\itshape ha:} & {\itshape ni:m{\Tilde}nima} & {\itshape nee} & {\itshape hiut{\Tilde}hitu} & {\itshape faun{\Tilde}fanu} & {\itshape seo / sea} & {\itshape bo{\textglotstop}es}\\
