...
The numerals `one' to `five' are for the most part simple mono-morphemic words in Alor- Pantar. Table \ref{tab:6:2} presents an overview with the reconstructions to proto-Alor-Pantar (pAP)\il{proto-Alor-Pantar}.\footnote{Not all elements of the reconstructed forms as they are given here are motivated in this chapter; see the reconstructed sound changes\is{sound change} reported on in \citet{HoltonEtAl2012} and \citet{HoltonEtAlTV}.  The Proto-AP\il{proto-Alor-Pantar} numerals `one' to `five' have been retained in most of its descendants. Only in eastern Alor have numerals in this range been innovated. 
...
\midrule 		
			&  {pAN}		&  {*enem} 					&  {*pitu} 					&  {*walu} 					\\[.6em]		
{Flores} 		&  Rongga 	&    \tabtrs{2.5cm}{lima esa}{5 1} 	&  \tabtrs{2.5cm}{lima{\textturnr}ua}{ 5 2} 			&  \tabtrs{2.5cm}{\textit{{\textturnr}uambutu}}{ 2 4} 			\\[.6em]	
			&  Ende 		&    \tabtrs{2.5cm}{limasa}{5 1} 			&  \tabtrs{2.5cm}{limazua}{ 5 2} 					&  \tabtrs{2.5cm}{ruabutu}{ 2 4} 	\\[.6em]		
			&  Ngadha 	&    \tabtrs{2.5cm}{lima esa}{ 5 1} 			&  \tabtrs{2.5cm}{limarua}{ 5 2} 					&  \tabtrs{2.5cm}{ruabutu}{ 2 4} 	\\[.6em]	
			&  Nage 		&    \tabtrs{2.5cm}{lima esa}{ 5 1} 			&  \tabtrs{2.5cm}{lima zua}{ 5 2} 				&  \tabtrs{2.5cm}{zua butu}{ 2 4} 		\\[.6em]	
			&  K\'eo {\dag} &    \tabtrs{2.5cm}{{\textglotstop}esa dima {\textglotstop}esa}{ 5 1}&  \tabtrs{2.5cm}{\textit{{\textglotstop}}\textit{esa dima rua}}{ 5 2} &  \tabtrs{2.5cm}{{\textglotstop}esa rua mbutu}{ 2 4} \\[.6em]	
			&  Lio 		&    {lima  {\textschwa}sa} 			&  lima rua 					&  \tabtrs{2.5cm}{rua mbutu}{ 2 4} 			\\[.6em]	
{Lembata} 		&  Kedang* 	&    {{\textgreater}{\ae}n{\ae}ng} 		&  pitu 					&  \tabtrs{2.5cm}{butu rai}{ 4 2?} 			    	\\[.6em]	
{Timor}		 	&  Mambae 	&    \tabtrs{2.5cm}{limnai nide}{ 5 1} 			&  \tabtrs{2.5cm}{limnai rua}{ 5 2} 				&  \tabtrs{2.5cm}{limnai telu}{ 5 3} 		\\[.6em]	
			&  Tokodede 	&    \tabtrs{2.5cm}{wouniso}{ [5] 1} 			&  \tabtrs{2.5cm}{wouru}{ [5] 2} 					&  \tabtrs{2.5cm}{woutelo}{ [5] 3} 	\\[.6em]	
\mybottomline
\end{tabular}
...
\midrule 
			&  {pAN}& {*siwa} 	&  {*puluq}\\\\
{Flores} 		&  Rongga 		&   \tabtrs{2.5cm}{taraesa}{ [10] 1 }	&  \tabtrs{2.5cm}{sambulu}{ 1 10}\\[.6em]	
			&  Ende 			&   \tabtrs{2.5cm}{trasa}{ [10] 1 }	& \tabtrs{2.5cm} {sabulu}{ 1 10}\\[.6em]
			&  Ngadha 		&   \tabtrs{2.5cm}{teresa}{ [10] 1 }	&  \tabtrs{2.5cm}{habulu}{ 1 10}\\[.6em]
			&  Nage 			&   \tabtrs{2.5cm}{tea esa}{ [10] 1 }	&  \tabtrs{2.5cm}{sa bulu}{ 1 10}\\[.6em]
			&  K\'eo {\dag}		 &  \tabtrs{2.5cm} {{\textglotstop}esa tera {\textglotstop}esa}{ [1 10] 1} 	& \tabtrs{2.5cm}{hambudu}{ 1 10}\\[.6em]
			&  Lio 			&   \tabtrs{2.5cm}{t{\textschwa}ra   {\textschwa}sa}{ [10] 1 }	&  \tabtrs{2.5cm}{sambulu}{ 1 10}\\[.6em]
{Lembata} 		&  Kedang* 		&   \tabtrs{2.5cm}{leme {\textgreater}apa{\textglotstop}}{ 5 4} 	&  \tabtrs{2.5cm}{pulu}{1 10}\\[.6em]
{Timor} 			&  Mambae 		&   \tabtrs{2.5cm}{limnai pata}{ 5 4} 	&  {sikul}\\[.6em]
			&  Tokodede 		&   \tabtrs{2.5cm}{woupat}{ [5] 4 }	&  \tabtrs{2.5cm}{sagulu}{ 1 10}\\[.6em]
\mybottomline
\end{tabular}
...
\midrule 
 & { PAN\ilt{proto-Austronesian}} & {*esa{\Tilde}*isa} & {*duSa} & {*telu} & {*Sepat} & {*lima} & {*enem} & {*pitu} & {*walu} & {*siwa} & {*puluq}\\
...
{Western Timor} & {Uab Meto\ilt{Uab Meto}} {\ddag} & \textit{m}\textit{{\textepsilon}}\textit{se} & {\itshape nua} & {\itshape tenu} & {\itshape ha} & {\itshape nim} & \textit{n}\textit{{\textepsilon}} & {\itshape hitu} & \textit{fanu}{\ddag} & {\itshape seo /sio} & \textit{bo{\textglotstop}}\textit{{\textepsilon}}\textit{s}{\dag}\\
 & {Amarasi\ilt{Amarasi}} & {\itshape es} & {\itshape nua} & {\itshape teun{\Tilde}tenu} & {\itshape haː} & {\itshape niːm{\Tilde}nima} & {\itshape nee} & {\itshape hiut{\Tilde}hitu} & {\itshape faun{\Tilde}fanu} & {\itshape seo / sea} & {\itshape bo{\textglotstop}es}\\
...
{Central Timor} & {Kemak\ilt{Kemak}} & {\itshape sia} & {\itshape hurua} & {\itshape telu} & {\itshape paːt} & \textit{h}\textit{{\textschwa}lima} & \textit{h}\textit{{\textschwa}nem} & {\itshape hitu} & {\itshape balu} & {\itshape sibe} & {\itshape sapulu}\\
...
{South-Central Timor} & {Tetun Fehan\ilt{Tetun Fehan}} & {\itshape ida} & {\itshape rua} & {\itshape tolu} & {\itshape haːt} & {\itshape lima} & {\itshape neen} & {\itshape hitu} & {\itshape walu} & {\itshape siwi} & {\itshape sanulu}\\
{North-Eastern Timor} & {Waima'a\ilt{Waima'a}} & {\itshape se} & {\itshape kairuo} & {\itshape kaitelu} & {\itshape kaihaː} & {\itshape kailime} & {\itshape kainena} & {\itshape kaihitu} & {\itshape kaikaha} & {\itshape kaisiwe} & {\itshape base}\\
 & {Dadu'a\ilt{Dadu'a}} & {\itshape isa} & {\itshape warua} & {\itshape watelu} & {\itshape waːk} & {\itshape walima} & {\itshape wanee} & {\itshape wa{\textglotstop}itu} & {\itshape wa{\textglotstop}ao} & {\itshape wasia} & {\itshape sanulu}\\
\mybottomline
\end{tabular}
