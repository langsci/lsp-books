...
Three primary regions can be identified in the graph, each separated by significant reticulation at the center of the graph. An East Alor region groups Kamang\il{Kamang}, Wersing\il{Wersing}, and Sawila\il{Sawila}; a Central Alor region groups Kui\il{Kui}, Klon\il{Klon}, and Adang\il{Adang}; and a Pantar region groups Kaera\il{Kaera}, Nedebang\il{Nedebang}, Teiwa\il{Teiwa}, and to a lesser extent Western Pantar\il{Western Pantar}. The high degree of reticulation within this latter group indicates a strong conflicting signal within this region. That is, of these three regions, the Pantar group is particularly non-tree-like, suggesting a pattern of wave-like innovations\is{innovation} in this region. In other words, although we found no shared phonological innovations\is{innovation} to subgroup these languages together in a traditional tree based on the comparative method, these languages have borrowed a great deal from one another. 
