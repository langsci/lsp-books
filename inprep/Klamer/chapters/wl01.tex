...
For those languages which have been the subject of recent investigation a reference is included in the table to a grammar or grammatical sketch that is published, or is about to be published. Further references to published work on the languages are presented in {\S} \ref{sec:1:3}.
...
Schapper,  Antoinette \& Rachel Hendery & Wersing\ilt{Wersing} corpus & Australian National\par  University\-\\ 
\end{tabular}
\end{table}
