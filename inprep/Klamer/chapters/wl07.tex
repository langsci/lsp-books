...
\caption{Sawila\ilt{Sawila} elevational\ist{elevation} motion\ist{motion} verbs (Kratochv\'il to appear and Kratochv\'il, Sawila corpus)}
%\label{}
\end{table}
...
Adang\ilt{Adang} 		&  \citet{Haan2001}, \citet{RobinsonEtAlToAppear} 	\\		
Blagar\ilt{Blagar}  		&  \citet{Steinhauer1977,Steinhauer1991,Steinhauer2012}, pers. comm. 	\\
Kaera\ilt{Kaera}  		&  \citet{KlamerToAppear} 		\\				
...
Sawila\ilt{Sawila} 	 	&  \citet{KratochvilToAppear}, Sawila Toolbox dictionary, p.c.\\
Teiwa\ilt{Teiwa}  		&  \citet{Klamer2010}, fieldnotes, Teiwa corpus\\
Wersing\ilt{Wersing}  	&  Schapper and Hendery Wersing corpus, to appear\\
Western Pantar\ilt{Western Pantar}  	&  \citet{Holton2007,Holton2011,HoltonToAppear}, Western Pantar corpus, p.c., \citet{HoltonEtAl2008}\\ 
\end{tabular}
