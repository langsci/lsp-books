...
\label{ex:7:12}
\langinfo{Abui}{}{Kratochv\'il, Abui corpus} \\
\gll {\dots} ha-buka{\ng} dika{\ng} mi     {\ob}\textbf{{\`o} nu}    do{\cb}\textsubscript{NP}={\ng}    pa. \\
