...
which derives a verb, e.g.\,\It{base\Bf{st}it} ‘to fry quickly’ (cf. \It{basset} ‘to fry’).\footnote{Cf. \SEC\ref{vblzST} for more on this verbalizer.} % \It{ájle\Bf{st}it} ‘to sanctify’.
