...
\multirow{2}{*}{/{v}u͡asːta/} &[{w}u͡asːta]\textasciitilde & \It{vuassta}		\\%&\hfill\hyperlink{110517b2}{\small[pit110517b2.038]}\\
					 &[{v}u͡asːta] 			& ‘cheese\BS\Sc{nom.sg}’ 	\\%&\hfill\hyperlink{080917c}{\small[pit080917c.9m42s]}\\
\end{tabular}
...
\multirow{2}{*}{/kolaː-ʧ-a/}	&[kʊ͡ɔlaːʧa]\textasciitilde	& \It{guolatja}			\\
					&[kʊ͡ɔlaːʧa{h}] 		& ‘fish-\Sc{dim}-\Sc{gen.sg}’ 	\\
\end{tabular}
