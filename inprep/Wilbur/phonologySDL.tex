...
are also found in consonant clusters in word-onset position, an environment usually found in recent and older loan words from (North) Germanic, as in examples \REF{queenNOMSG}\marginpar{Check placement of footnote in \REF{queenNOMSG}} and \REF{icecreamNOMSG}. %
