...
\PS\ has eight monophthong vowel phonemes and one diphthong\is{diphthong} vowel phoneme. The monophthongs are listed in the vowel chart\is{phoneme inventory!vowels} in Figure~\vref{monophthongs}, and the diphthong is listed in Figure~\vref{diphthongs}. 
\begin{figure}[h]
\centering
...
\begin{tabular}{p{18mm}p{22mm}l}/ɲalːke/	&[ɲalːke]\TILDE&\It{njallge}\\\end{tabular}\hfill\hyperlink{explExs}{\small[2323]}\\
