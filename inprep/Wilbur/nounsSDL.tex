...
The accusative case (\ACCs) marks the object of a transitive verb, as illustrated by the monotransitive clause in \REF{acc1}.  
\ea\label{acc1}
...
The inessive case (\INESSs) marks nouns which function as adjuncts to verbal clauses indicating the location of the event or action, as in \REF{iness1}. 
...
The essive case (\ESSs) generally marks predicative nouns functioning as complements of verbs such as \It{sjaddat} ‘become’, as in \REF{ess1a} and \REF{ess1b}, and \It{gähtjoduvvat} ‘be called’, as in \REF{ess2}. Note that nouns in the essive case do not inflect for number. 
...
not marked by any linear morphology. %(although even this has exceptions). 
...
\begin{itemize}
\item{\It{str-wk} grade alignment (when relevant)}
...
\item{\It{wk-str} grade alignment (when relevant)}
\end{itemize}
