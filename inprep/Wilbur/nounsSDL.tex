...
Furthermore, the nominal complement in a postpositional phrase occurs in the genitive case, %UM: revise, add sources, or DELETE footnote: \footnote{Historically, postpositional phrases stem from a figurative use of possession relationships concerning spatial relations; see §\,\ref{postpositions} for more details.} 
