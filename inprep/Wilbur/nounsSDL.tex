...
Furthermore, the nominal complement in a postpositional phrase\is{phrase!postpositional} occurs in the genitive case, as the noun \It{gåde} ‘hut’ in \REF{gen2}.
\ea\label{gen2}
