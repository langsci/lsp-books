...
\end{tabular}
\end{table}It is tempting to posit a plural marking suffix \It{-j} because it occurs in \Sc{gen.pl},  \Sc{acc.pl}, \Sc{ill.pl},  \Sc{iness.pl}, \Sc{elat.pl} and \Sc{com.pl}; however, the \Sc{ill.sg} suffix \It{-j} and the \Sc{com.sg} suffix \It{-jn(a)} both have a similar \It{-j} element, but are clearly not plural. 
