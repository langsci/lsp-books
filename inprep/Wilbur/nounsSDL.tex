...
The possessed noun in a possessive copular clause (cf. \SEC\ref{copulaClauses}) is also in the nominative case, as in \REF{nom3}.
\ea\label{nom3}
...
Furthermore, the nominal complement in a postpositional phrase occurs in the genitive case, as the noun \It{gåde} ‘hut’ in \REF{gen2}.
\ea\label{gen2}
...
The possessor noun in a possessive copular clause (cf. \SEC\ref{copulaClauses}) is also in the inessive case, as in \REF{iness3}.
%In possessive copula clauses, the possessor is in this case as in \REF{SaamiHasDog}.\footnote{Cf. \SEC\ref{possCopClause} on the possessive copula clause}
\ea\label{iness3}
\glll	{sámen} lä bena\\
	sáme-n lä bena\\
...
not marked by any linear morphology (although even this has exceptions). The nominal suffixes marking case and number are listed in Table \vref{nounSuffixes}. Note that the status of the abessive suffixes is unclear, including whether they inflect for number, as discussed in \SEC\ref{abessiveProblematic}. Nouns in essive case do not inflect for number.
...
\begin{tabular}{ l p{20mm} |  l  }\dline
%\begin{tabular}{ l p{35mm}  p{35mm}  }\dline
%			&\MC{2}{l}{\It{number}}			\\
...
\Sc{ess}	& \MC{2}{c }{\It{-n}}				\\\dline%\hline
...
\It{ålolij}	&\It{ålolijn}	&\It{ålolin}		&\It{ålola(h)}	& ‘tool’ 	\\\dline
\end{tabular}
}
\end{table}
...
\begin{tabular}{ lll l l }\dline
%\begin{tabular}{ y{30mm}  y{30mm}  y{30mm} c p{20mm} }\dline
...
\It{bednaga(-h)}		& \It{bednagi-j}		& \It{bednagi-jn}	&IIIb & ‘dog’ \\\dline
\end{tabular}}
\end{table}
...
%\begin{tabular}{ r  x{35mm}  x{35mm}  l }\dline
%			&\MC{2}{l}{\It{number}}			&	\\
		& \SG 			& \PL		\\\hline
\Sc{nom}	&   				&  			\\%\cline{2-3}
...
In summary, the inflectional paradigm for \It{bärrgo} is characterized by both consonant gradation and umlaut in the stem, %\footnote{As described in \SEC\ref{}, umlaut only occurs in stems with consonant gradation, but consonant gradation can occur without umlaut.} %JW: NOT true, cf. bägga-biegga (wind)
...
\Sc{com}	& 								& \\%\cline{1-1}
\Sc{abess}	& 								& \\\cline{2-3}
\Sc{ess}	&\MC{2}{|c|}{ \It{ä}\PLUS str}\\\dline%\hline
\end{tabular}
\end{table}
...
\begin{tabular}{c c c  c c c  l}\dline
%\MC{3}{l}{\It{pattern}}	&\MC{3}{l}{\It{examples}}&	\\
...
\Sc{ess}		&\MC{2}{c}{str}	&\MC{2}{c}{\It{-V-}}\\\dline%\hline
%\MR{2}{*}{\Sc{ess}}&\MC{2}{l}{{C-grad}}	&\MC{2}{l}{{class suffix}}	\\%\cline{2-5}
%		&\MC{2}{l}{str}	&\MC{2}{l}{-V-}\\\dline%\hline
\end{tabular}
\end{table}
...
\Sc{ess}	&\MC{2}{c}{\It{luakkt-a-n}} \\\dline%\hline
\end{tabular}
\end{table}
...
\Sc{ess}	&\MC{2}{c}{\It{bäbbm-o-n}}\\\dline%\hline
\end{tabular}
\end{table}
...
\Sc{ess}	&\MC{2}{c}{\It{skåvvl-å-n}}\\\hline%\hline
\end{tabular}
\end{table}
...
\begin{itemize}
\item{\jvh}
\item{allomorphy in the class markers (\It{e}, \It{i}, \It{á})}
\end{itemize}
...
\Sc{ess}	&\MC{2}{c}{\It{guoll-e-n}} \\\dline%\hline
\end{tabular}
\begin{tabular}{l}
\\
\end{tabular}
...
\Sc{ess}	&\MC{2}{c}{\It{vágg-e-n}} \\\dline%\hline
\end{tabular}
\end{table}
...
\Sc{ess}	&\MC{2}{l}{str}	&\MC{2}{l}{\It{-e-}}\\\dline%\hline
%\begin{tabular}{ r  c  c |}
%			&\MC{2}{c|}{\It{number}\\
%\It{case}	& \Sc{singular}	& \Sc{plural}	 \\\hline
...
\Sc{ess}	&\MC{2}{c}{\It{båts-o-n}} \\\dline%\hline
...
\Sc{abess}	& n/a		& n/a	\\%\hline%\cline{2-3}
\Sc{ess}	&\MC{2}{c}{\It{ålm-a-n}}\\\dline%\hline
\end{tabular}
\end{table}
...
%\MR{2}{*}{\Sc{ess}}	&\MC{2}{l}{\It{C-grad}}	&\MC{2}{l}{\It{class suffix}}	\\%\cline{2-5}
\Sc{ess}	&\MC{2}{c}{wk}	&\MC{2}{c}{\It{-V-}}\\\dline%\hline
%\begin{tabular}{ r  c  c |}
%			&\MC{2}{c|}{\It{number}\\
%\It{case}	& \Sc{singular}	& \Sc{plural}	 \\\hline
...
There do not appear to be many words in Class II, and the data in the corpus is ultimately inconclusive. %
...
%\MR{2}{*}{\Sc{ess}}	&\MC{2}{l}{\It{C-grad}}	&\MC{2}{l}{\It{class suffix}}	\\%\cline{2-5}
\Sc{ess}	&\MC{2}{c}{n/a}	&\MC{2}{c}{n/a}\\\dline%\hline
%\begin{tabular}{ r  c  c |}
%			&\MC{2}{c|}{\It{number}\\
%\It{case}	& \Sc{singular}	& \Sc{plural}	 \\\hline
%\Sc{nom}	& -Vj			& -V		\\\hline%\cline{2-3}
...
III	&a		& \It{sabek}		& \It{sabeg-a}		& \It{sabeg-a-v}		& \It{sabeg-i-j}		& \It{sabeg-i-j}		& \It{sabeg-i-st}		& ‘ski’		\\%\cline{3-9}%\hline
	...
	&		& \It{gáma}		& \It{gábmag-a}		& \It{gábmag-a-v}	& \It{gábmag-i-j}	& \It{gábmag-i-j}	& \It{gábmag-i-st}	& ‘shoe’	\\\dline
\end{tabular}
\end{sidewaystable}
%\end{table}
%\FB
...
\Transl{my father is checking if there is an unmarked calf}{}	\Corpus{080909}{004}
\z
