...
\hline\hline{phoneme}	&{letter or}	&		\\
{(IPA)}		&{letters}	&{context}	\\\hline%& example \\\hline
\endfirsthead
...
\IPA{u͡a}	&\Grapheme{ua}	& default digraph	\\*
		&\Grapheme{uä}	& allophone (umlaut) \\\dline%& \It{buäjjde} ‘fat’ \\\hline
...
\begin{tabular}{p{.82\columnwidth}p{37pt}}\dline
