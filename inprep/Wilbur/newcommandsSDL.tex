...
\newcommand{\TILDE}{～}%shortcut for tilde%’\Tilde’ clash with LSP!%\newcommand{\TILDE}{{\fontspec{Arial Unicode MS}～}}%shortcut for tilde
...
\newcommand{\ARROW}{→}%nicer looking arrow
%dieser dicke Pfeil wird nicht von der LSP-Font unterstützt: %\newcommand{\ARROW}{{\fontspec{DejaVu Sans}➜}}%nicer looking arrow
