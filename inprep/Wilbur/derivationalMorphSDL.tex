...
Note that the noun \It{báhkojådedäddje} ‘chairperson’ in \REF{agentNMLZex3} is a compound calque based on the Swedish\is{language contact} equivalent \It{ordförande}, which literally means ‘word-driver’. It is not clear whether ?\It{jådedäddje} ‘driver’ exists on its own. 
