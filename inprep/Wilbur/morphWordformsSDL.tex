...
\BULLET\ predicative adjectives		&comparative, superlative, number	\\\dline
\end{tabular}
\end{table}
...
between a geminate consonant and the corresponding singleton consonant \mbox{(xː\Div x)}, 
between a geminate\PLUS singleton and the corresponding singleton\PLUS singleton \mbox{(xːy\Div xy)}, 
...
These patterns and the attested alternations are provided in Table \vref{CgradPatternSummary}. The term \It{strong grade} (abbreviated ‘str’) is used to refer to the form with preaspiration, a geminate or more consonant segments than the corresponding form. Likewise, the term \It{weak grade} (abbreviated ‘wk’) refers to the form lacking a preaspirated or geminate consonant, or having fewer consonant segments, respectively. 
...
\begin{tabular}{c c c p{240pt}}\dline
%\MC{3}{c}{{pattern}}&\\
...
\begin{tabular}{ccccccc}\dline
\MC{3}{c}{{IPA}}&	&\MC{3}{c}{{orthography}}\\\hline
ɛ &\DARROW& e &&\It{ä} &\DARROW& \It{ie} \\
u͡a &\DARROW& o &&\It{ua}/\It{uä} &\DARROW& \It{uo} \\
\dline\end{tabular}
...
The term \It{vowel harmony} (abbrviated ‘VH’) here refers to non-adjacent regressive phonological assimilation concerning the place of articulation of the V1 vowel of a stem in the context of certain V2 vowels.\footnote{Cf. \SEC\ref{prosodicDomains} on prosodic positions, including V1 and V2 positions.} 
...
\begin{tabular}{x{30pt}cx{30pt}cc}\dline
...
verbs	&class II			&\Sc{1du.prs, 3pl.prs, 1sg.pst, 2sg.pst,} 		\\%\cline{2-3}
		...
		&				&\Sc{1pl.pst, 2pl.pst, 3pl.pst, pl.imp} 	\\\dline
...
\MC{2}{l}{{adverbials}}& \SEC\ref{adverbs}	&&\\\dline
...
\begin{tabular}[l]{l p{130pt} p{130pt}}\dline
...
interjections	& none							&independent words at clause-level	\\\dline
\end{tabular}
%%%Other way around:
