...
The specific syntactic criteria and inflectional categories defining these are summarized in Table \ref{wordClassSummary1} on the same page. %\footnote{The abbreviation} 
% as follows:
