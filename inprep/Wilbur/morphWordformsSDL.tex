...
\Sc{nominals} refer to \Sc{nouns} %(including a subcategory for predicative adjectives) 
and \Sc{pronouns} (personal, demonstrative, reflexive, interrogative and relative), and \Sc{adjectivals} include both \Sc{adjectives} and \Sc{numerals}. %Sets of finite and non-finite \Sc{verbs} belong to the same lexeme. 
...
Chapter \ref{nouns} concerns the nominal subclass \Sc{nouns}, which provide a fairly straightforward example of the morphophonological complexities involved in inflectional paradigms, while 
the nominal subclass \Sc{pronouns} is dealt with in the following chapter (Ch. \ref{pronouns}). % for the sake of clarity. 
Chapter \ref{adjectivesIntro} then covers the adjectival subclasses \Sc{adjectives} and \Sc{numerals}. Following this, Chapter \ref{verbs} deals with \Sc{verbs}. Finally, the remaining small classes (\Sc{adverbials}, \Sc{adpositions}, \Sc{conjunctions} %, \Sc{particles}, 
and \Sc{interjections}) are covered in Chapter \ref{otherWordClasses}. 
