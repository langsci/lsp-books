...
Alternations can be between a preaspirated\is{preaspiration} and the corresponding non-aspirated consonant \mbox{(ʰx\Div x)},  
...
\end{tabular}
\end{table}
The term \It{strong grade}\is{strong grade} (abbreviated ‘str’) is used to refer to the form with preaspiration\is{preaspiration}, a geminate\is{geminate} or more consonant segments than the corresponding form. Likewise, the term \It{weak grade}\is{weak grade} (abbreviated ‘wk’) refers to the form lacking a preaspirated or geminate consonant, or having fewer consonant segments, respectively. 
...
\hfill\hyperlink{pit101208}{{\small [pit101208]}}}
\z
For lexemes subject to consonant gradation, forms featuring /ɛ/ or /u͡a/ are typically in the strong grade\is{strong grade}, while forms with /e/ or /o/ are normally in the weak grade\is{weak grade}; cf. the word forms in example \REF{umlautEx2}. \is{umlaut|)}
...
\section{Overview of word classes}\label{introWordForms}\is{parts of speech}\is{word classes}
