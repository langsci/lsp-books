...
\Sc{com}	&mujna			&dujna			&sujna			&\\\hline%%\cline{1-4}%\hline
...
\Sc{com}	&munujn			&dunujn			&sunujn			&\\\hline%%\cline{1-4}%\hline
...
\GENs	&-n		&-j		\\
\ACCs	&-v		&-jt		\\
\ILLs		&-sa		&-jda		\\%%in final copy of dissertation, ILL.PL listed as -j <-- MISTAKE!!
\INESSs	&-n		&-jtne	\\
\ELATs	&-sste	&-jste	\\
\COMs	&-jna		&-j		\\\hline
\end{tabular}
...
\Sc{com}	&etjajnen			&(etjajnat)			&(etjajnis)			&\\\hline%%\cline{1-4}%\hline
...
\Sc{com}	&(etjajnenen)		&(etjajneten)		&(etjajneská)		&\\\hline%%\cline{1-4}%\hline
%\Sc{ess}	&\MC{3}{c|}{\it }								&\\\dline
...
Reflexive pronouns are frequently used to add emphasis to the noun phrase they are coreferential with (as an intensifier), as in \REF{reflPron3}.
\ea\label{reflPron3}%
...
\NOMs	&mij		&ma(h)	\\
\GENs	&man	&mej		\\
\ACCs	&mav	&mejd\TILDE majd	\\%JW: mejd DS, majd ER (but DS has majd for relative pronoun?)
\ILLs		&masa	&mejda	\\
\INESSs	&manne	&majdne	\\
...
\Transl{and then he is also looking a little which reindeer bulls they should also slaughter}{}	\Corpus{080909}{006}
\z
