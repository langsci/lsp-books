...
Interrogative pro-forms not referring to NPs mostly feature the stem \It{g-} (Section \ref{interrogativeProForms}). This classification is summarized in Figure \vref{interrogativeProFormSummary}, which also indicates the stem for each type.
