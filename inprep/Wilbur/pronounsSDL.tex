...
The nominative\is{nominative} forms all have two possible forms, e.g. \It{mån}\TILDE\It{månnå} ‘\Sc{1sg.nom}’. In general, the monosyllabic form is the default, while the bisyllabic form is typically used as a citation form and when the pronoun is emphasized.
...
Reflexive pronouns are frequently used to add emphasis to the \is{noun phrase}noun phrase they are coreferential with (as an intensifier), as in \REF{reflPron3}.
\ea\label{reflPron3}%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Interrogative pronouns}\label{interrogativePronouns}\is{pronoun!interrogative|(}
...
See \SEC\ref{relativeClauses} for a number of examples with relative pronouns as well as a description of relative clauses\is{relative clause}. %, and some examples are provided in \REF{relativePronounsEx1} through \REF{relativePronounsEx3}.
\begin{table}[ht]\centering
