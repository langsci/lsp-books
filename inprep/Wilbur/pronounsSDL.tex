...
Reflexive pronouns are frequently used to add emphasis to the noun phrase\is{noun phrase} they are coreferential with (as an intensifier), as in \REF{reflPron3}.
\ea\label{reflPron3}%
