...
\Sc{com}	& \It{mijájn		} & \It{dijájn			} & \It{sijájn		}	&\\\dline%\cline{1-4}%\hline
%\Sc{ess}	&\MC{3}{c|}{?}									&\\\dline
\end{tabular}
\end{table}
...
Note that demonstratives are identical in form, but differ syntactically as they modify the head of an NP; they are discussed in \SEC\ref{demonstratives}. 
...
\Sc{com}	& \It{(etjajneneh)		} & \It{(etjajneteh)		} & \It{(etjajneseh)		} &\\\dline%\cline{1-4}%\hline
%\Sc{ess}	&\MC{3}{c|}{}									} &\\\dline
\end{tabular}
\end{table}
\pagebreak
...
\COMs	& \It{mikkirijna}& \It{mikkirij	} \\\hline
%\ABESSs	&		&		\\\hline
%\ESSs	&\MC{2}{c|}{?}		\\\hline
\end{tabular}
\end{table}
...
\COMs	& \It{gåbajn(a)}& \It{gåbaj	} \\\hline
%\ABESSs	&		&		\\\hline
%\ESSs	&\MC{2}{c|}{?}		\\\hline
\end{tabular}
\end{table}
