...
\TranslLong{but they obviously didn't eat out of that, but they had food, meat and so on in such things}{} \CorpusLink{080708_Session03}{080708\_Session03}{019}
\z
...
%A final type of clausal subordination, when embedded in an NP, a subordinate clause is a relative clause, and covered in Section \ref{relativeClauses}.
...
\glll	ja dat lij samma, jus del lij guallbana vaj bijjadaga vaj smav biehtsasdaga\\
	...
	and \Sc{dem}-\Sc{dist}-\Sc{nom.sg} be-\Sc{3sg.pst} same if then be-\Sc{3sg.pst} flat\_pine\_heath-\Sc{nom.pl} or high\_ground-\Sc{nom.pl} or small pine\_forest-\Sc{nom.pl}\\\nopagebreak
...
\glll	dat lä náhppe man sisa båhtjen buhtsujd\\
	...
	\Sc{dem}-\Sc{dist}-\Sc{nom.sg} be\BS\Sc{3sg.prs} milking\_bowl\BS\Sc{nom.sg} \Sc{rel}-\Sc{gen.sg} into milk-\Sc{3pl.pst} reindeer-\Sc{acc.pl}\\\nopagebreak
