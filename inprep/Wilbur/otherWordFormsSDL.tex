...
Two examples are provided in \REF{postpositionEx1} and \REF{postpositionEx2}; for more on the syntactic behavior of postpositions in postpositional phrases as well as more examples, see §\,\ref{postpositionalPhrases}. %
