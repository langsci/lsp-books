...
Adverbs compose an open word class and are defined by their ability to head an adverbial phrase\is{phrase types!adverbial phrase}; they can be further divided into two main groups: 
\begin{itemize}
...
Adpositions in \PS\ constitute a closed class of words that are defined syntactically by their ability to head an adpositional phrase\is{phrase types!adpositional phrase} (abbreviated ‘PP’ as these are either postpositional\is{phrase types!postpositional phrase} or prepositional phrases\is{phrase types!prepositional phrase}). 
...
Postpositions are complemented by NPs in the genitive\is{case!genitive} case. 
...
NPs\is{phrase types!nominal phrase}, APs\is{phrase types!adjectival phrase} and verbs\is{verb} can be connected to another phrase of the same type by a conjunction; however, it is not clear from the data whether PPs\is{phrase types!postpositional phrase} or AdvPs\is{phrase types!adverbial phrase} can be connected. 
