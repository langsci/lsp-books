...
A further lexical adverb is \It{gal} ‘actually’, which can be used to emphasize a contradiction or surprise, as in \REF{particleEx6}. The interjection \It{nä} ‘no’, a borrowing from Swedish,\footnote{< Sw. \It{nej} ‘no’; cf. local dialect pronunciation [nɛː].} 
...
The interjection \It{jå} ‘yes’, also a Swedish borrowing,\footnote{< Sw. \It{jå}, a common pronunciation of \It{ja} ‘yes’.} 
