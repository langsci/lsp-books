...
\begin{itemize}
\item{adverbs in §\,\ref{adverbs},}
\item{adpositions in §\,\ref{adpositions},}
\item{conjunctions in §\,\ref{conjunctions},}
%\item{particles in §\,\ref{particles}}
\item{and interjections in §\,\ref{interjections}}
\end{itemize}
...
Here, §\,\ref{derivedADVs} deals with the former, while §\,\ref{lexicalADVs} presents with the latter. 
...
\begin{tabular}{cccc}
\ATTRs\ \It{adjective}	&\ARROW&\It{adverb}	&\It{gloss}	\\\hline
...
Postpositions, which are clearly preferred over prepositions, are covered in §\,\ref{postpositions}. The limited data on prepositions, which, with on exception, can all be used as postpositions as well, are described in §\,\ref{prepositions}. 
...
Two examples are provided in \REF{postpositionEx1} and \REF{postpositionEx2}; for more on the syntactic behavior of postpositions in postpositional phrases as well as more examples, see §\,\ref{postpositionalPhrases}. %on postpositional phrases, including examples from the corpus illustrating postpositions.%UM: delete
...
With the exception of \It{dugu} ‘like’, which governs a noun in either the essive or the nominative case (cf. §\,\ref{essive}), 
...
\It{conjunction}	&\It{phrases}	&\It{clauses}	&\It{equivalent}	\\\hline
att			&			&\CH		& ‘(in order) to’	\\
eller			&\CH		&\CH		& ‘or’	\\
gu			&			&\CH		& ‘when’	\\
ja			&\CH		&\CH		& ‘and’	\\
...
Conjunctions connecting clauses are discussed in §\,\ref{clausalCoordination} (coordination) and §\,\ref{clausalSubordination} (subordination). 
