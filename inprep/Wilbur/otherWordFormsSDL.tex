...
Postpositions, which are clearly preferred over prepositions, are covered in §\,\ref{postpositions}. The limited data on prepositions, \korr{045}which, with on exception, can all be used as postpositions as well, are described in §\,\ref{prepositions}. 
