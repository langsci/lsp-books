...
Adpositions in \PS\ constitute a closed class of words that are defined syntactically by their ability to head an adpositional phrase\is{phrase!adpositional} (abbreviated ‘PP’ as these are either postpositional\is{phrase!postpositional} or prepositional phrases\is{phrase!prepositional}). 
