...
\z
The person/number suffixes for potential mood are homophonous %!! syncretism is homonymy of morphemes in the same paradigm 
...
The progressive form of a verb can also be used in an adverbial function. For instance, \It{tjájbmamin} ‘laughing’ in \REF{ADVverbsEx1} and \It{gullamin} ‘listening‘ in \REF{ADVverbsEx2} are each used as a modal adverbial to indicate a simultaneous activity. 
...
As with any finite verb, the negation verb agrees in person and number with the subject of the sentence, and inflects for tense or mood. The complement verb occurs in a special non-finite verb form called the connegative (glossed as \mbox{\CONNEGs}), which is in the weak grade (when gradation is relevant) and otherwise lacks any additional morphological marking. Examples for present and past indicative as well as imperative forms are provided in \REF{connegEx1} through \REF{negImpEx1}. 
\ea\label{connegEx1}%
...
\It{mood}			&\It{person}	&\MC{1}{c}{\SGs}	&\MC{1}{c}{\DUs}			&\Xp{\PLs}	\\\hline
%PRESENT
\PRSs	&1\superS{st}	&-v		&-n/-jin/-n			&\Xp{-p}		\\%%\cline{3-5}
				&2\superS{nd}	&-		&-bähten/-bähten/ -hpen&\Xp{-ähtet/-bähtet/ -hpit}\\%%\cline{3-5}
				&3\superS{rd}	&-/-ja/-	&-ba				&\Xp{-/-je/-}	\\%\cline{2-5}%JW: removed ‘-hpa’ from 3DU.PRS because it doesn’t seem to exist in corpus
%PAST
\PSTs	&1\superS{st}	&-v/-jiv/-jiv&-jmen			&\Xp{-jmä/-jme/-jme}	\\%%\cline{3-5}
				&2\superS{nd}	&-/-je/-je	&-jden			&\Xp{-jdä/-jde/-jde}		\\%%\cline{3-5}
				&3\superS{rd}	&-j		&-jga				&\Xp{-n/-jin/-n}		\\%\cline{2-5}
%IMPERATIVE
\IMPs			&2\superS{nd}	&-		&-n/n/a/-hten		&\Xp{-t/n/a/-htet}	\\\hline%%\cline{3-5}
&&&&\\
%NON-FINITES
\MC{5}{l}{\It{non-finite verb forms:}}\\\hline
\MC{1}{c}{\INFs}	&\MC{2}{c}{-t}			&\MC{1}{c}{\CONNEGs}&-			\\
\MC{1}{c}{\PRFs}	&\MC{2}{c}{-m}			&\MC{2}{c}{}			\\\hline%\hline%\cline{1-3}
\end{tabular}}
\end{table}
...
To illustrate this, the inflectional paradigm for the verb \It{buälldet} ‘ignite, burn’ is provided in Table \vref{verbBurn} and described below. 
...
\It{mood}			&\It{person}	&\MC{1}{c}{\SGs}		&\MC{1}{c}{\DUs}			&\Xp{\PLs}	\\\hline
%PRESENT
\PRSs	&1\superS{st}	&buold-a-v	&bulld-e-n			&\Xp{buälld-e-p}		\\%\cline{3-5}
				&2\superS{nd}	&buold-a		&buälld-e-bähten	&\Xp{buälld-e-bähtet}	\\%\cline{3-5}
				&3\superS{rd}	&bualld-a		&buälld-e-ba		&\Xp{bulld-e}		\\%\cline{2-5}
%PAST
\PSTs	&1\superS{st}	&bulld-i-v		&buld-i-jmen		&\Xp{buld-i-jmä}	\\%\cline{3-5}
				&2\superS{nd}	&bulld-e		&buld-i-jden		&\Xp{buld-i-jdä}		\\%\cline{3-5}
				&3\superS{rd}	&buld-i-j		&buld-i-jga		&\Xp{bulld-e-n}		\\%\cline{2-5}
%IMPERATIVE
\IMPs			&2\superS{nd}	&buold-e		&buälld-e-n			&\Xp{n/a}		\\\hline%%\cline{3-5}
&&&&\\
\MC{5}{l}{\It{non-finite verb forms:}}\\\hline
\MC{1}{c}{\INFs}	&\MC{2}{c}{buälld-e-t}		&\MC{1}{c}{\CONNEGs}&buold-e			\\
\MC{1}{c}{\PRFs}	&\MC{2}{c}{bualld-a-m}		&\MC{2}{c}{}			\\\hline%\cline{1-3}
\end{tabular}}
\end{table}
...
\It{mood}			&\It{person}	&\MC{1}{c}{\SGs}		&\MC{1}{c}{\DUs}			&\Xp{\PLs}	\\\hline
%PRESENT
\PRSs	&1\superS{st}	&\MC{1}{|c|}{uo\PLUS wk}		&\MC{1}{c|}{\It{VH}\PLUS str}			&\Xp{uä\PLUS str}		\\\cline{4-4}
				&2\superS{nd}	&\MC{1}{|c|}{uo\PLUS wk}		&\MC{1}{c}{uä\PLUS str}	&\Xp{uä\PLUS str}		\\\cline{3-3}\cline{5-5}
				&3\superS{rd}	&\MC{1}{c}{ua\PLUS str}	&uä\PLUS str			&\MC{1}{|c|}{\It{VH}\PLUS str}		\\\cline{3-5}
%PAST
\PSTs	&1\superS{st}	&\MC{1}{|c|}{\It{VH}\PLUS str}		&\MC{1}{c}{\It{VH}\PLUS wk}	&\Xp{\It{VH}\PLUS wk}		\\%%\cline{3-5}
				&2\superS{nd}	&\MC{1}{|c|}{\It{VH}\PLUS str}		&\MC{1}{c}{\It{VH}\PLUS wk}	&\Xp{\It{VH}\PLUS wk}		\\\cline{3-3}\cline{5-5}
				&3\superS{rd}	&\MC{1}{c}{\It{VH}\PLUS wk}&\It{VH}\PLUS wk		&\MC{1}{|c|}{\It{VH}\PLUS str}		\\\cline{3-5}
%IMPERATIVE
\IMPs			&2\superS{nd}	&\MC{1}{|c|}{uo\PLUS wk}	&\MC{1}{c|}{uä\PLUS str}			&\MC{1}{c|}{n/a}			\\\hline%%\cline{3-5}
&&&&\\
\MC{5}{l}{\It{non-finite verb forms:}}\\\hline
\MC{2}{c}{\INFs}	&\MC{1}{|c|}{uä\PLUS str}			&\MC{1}{c}{\CONNEGs}&\MC{1}{|c|}{uo\PLUS wk}		\\\cline{5-5}
\MC{2}{c}{\PRFs}	&\MC{1}{|c|}{ua\PLUS str}			&\MC{2}{c}{}					\\\hline%\cline{1-3}
\end{tabular}}
\end{table}
%\FB
...
\It{mood}			&\It{person}	&\MC{1}{c}{\SGs}	&\MC{1}{c}{\DUs}		&\Xp{\PLs}	\\\hline
%PRESENT
\PRSs	&1\superS{st}	&vies-o-v	&viess-o-n		&\Xp{viess-o-p}		\\%\cline{3-5}
				&2\superS{nd}	&vies-o	&viess-o-bähten	&\Xp{viess-o-bähtet}	\\%\cline{3-5}
				&3\superS{rd}	&viess-o	&viess-o-ba		&\Xp{viess-o}		\\%\cline{2-5}
%PAST
\PSTs	&1\superS{st}	&viess-o-v	&vies-o-jmen		&\Xp{vies-o-jme}	\\%\cline{3-5}
				&2\superS{nd}	&viess-o	&vies-o-jden		&\Xp{vies-o-jde}		\\%\cline{3-5}
				&3\superS{rd}	&vies-o-j	&vies-o-jga		&\Xp{viess-o-n}		\\%\cline{2-5}
%IMPERATIVE
\IMPs			&2\superS{nd}	&vies-o	&viess-o-n		&\Xp{viess-o-t}		\\\hline%%\cline{3-5}
&&&&\\
\MC{5}{l}{\It{non-finite verb forms:}}\\\hline
\MC{1}{c}{\INFs}	&\MC{2}{c}{viess-o-t}	&\MC{1}{c}{\CONNEGs}&vies-o			\\
\MC{1}{c}{\PRFs}	&\MC{2}{c}{viess-o-m}	&\MC{2}{c}{}\\\hline%\cline{1-3}
\end{tabular}}
\end{table}
...
\begin{tabular}{cc cc cc cc}
				&			&\MC{6}{c}{\It{number}}	\\
\It{tense/}			&			&\MC{2}{c}{\SGs}			&\MC{2}{c}{\DUs}			&\MC{2}{c}{\PLs}	\\%\hline
...
The verb \It{bassat} ‘wash’ is provided in Table \vref{washParadigm} as an example for a Class IIa verb, and \It{bårråt} ‘eat’ for a Class IIb verb in Table \ref{eatParadigm}. 
...
\It{mood}			&\It{person}	&\MC{1}{c}{\SGs}	&\MC{1}{c}{\DUs}		&\Xp{\PLs}	\\\hline
%PRESENT
\PRSs	&1\superS{st}	&bas-a-v	&biss-i-n			&\Xp{bass-a-p}		\\%\cline{3-5}
				&2\superS{nd}	&bas-a	&bass-a-bähten	&\Xp{bass-a-bähtet}	\\%\cline{3-5}
				&3\superS{rd}	&bass-a	&bass-a-ba		&\Xp{biss-e}		\\%\cline{2-5}
%PAST
\PSTs	&1\superS{st}	&biss-i-v	&bas-a-jmen		&\Xp{bas-a-jmä}	\\%\cline{3-5}
				&2\superS{nd}	&biss-e	&bas-a-jden		&\Xp{bas-a-jdä}		\\%\cline{3-5}
				&3\superS{rd}	&bas-a-j	&bas-a-jga		&\Xp{biss-i-n}		\\%\cline{2-5}
%IMPERATIVE
\IMPs			&2\superS{nd}	&bas-a	&bass-e-n			&\Xp{bess-i-t}		\\\hline%%\cline{3-5}
&&&&\\
\MC{5}{l}{\It{non-finite verb forms:}}\\\hline
\MC{1}{c}{\INFs}	&\MC{2}{c}{bass-a-t}	&\MC{1}{c}{\CONNEGs}&bas-a			\\
\MC{1}{c}{\PRFs}	&\MC{2}{c}{bass-a-m}	&\MC{2}{c}{}\\\hline%\cline{1-3}
\end{tabular}}
\end{table}
\begin{table}\centering
...
\It{mood}			&\It{person}	&\MC{1}{c}{\SGs}	&\MC{1}{c}{\DUs}		&\Xp{\PLs}	\\\hline
%PRESENT
\PRSs	&1\superS{st}	&bår-å-v	&burr-e-n			&\Xp{bårr-å-p}		\\%\cline{3-5}
				&2\superS{nd}	&bår-å	&bårr-å-bähtin		&\Xp{bårr-å-bähtet}	\\%\cline{3-5}
				&3\superS{rd}	&bårr-a	&bårr-å-ba		&\Xp{burr-e}		\\%\cline{2-5}
%PAST
\PSTs	&1\superS{st}	&burr-e-v	&bår-å-jmen		&\Xp{bår-å-jme}	\\%\cline{3-5}
				&2\superS{nd}	&burr-e	&bår-å-jden		&\Xp{bår-å-jde}		\\%\cline{3-5}
				&3\superS{rd}	&bår-å-j	&bår-å-jga			&\Xp{burr-e-n}		\\%\cline{2-5}
%IMPERATIVE
\IMPs			&2\superS{nd}	&bår-å	&bårr-e-n			&\Xp{burr-i-t}		\\\hline%%\cline{3-5}
&&&&\\
\MC{5}{l}{\It{non-finite verb forms:}}\\\hline
\MC{1}{c}{\INFs}	&\MC{2}{c}{bårr-å-t}			&\MC{1}{c}{\CONNEGs}&bår-å		\\\MC{1}{c}{\PRFs}	&\MC{2}{c}{bårr-å-m}	&\MC{2}{c}{}\\\hline%\cline{1-3}
\end{tabular}}
\end{table}
...
\begin{tabular}{cc ccc ccc ccc}
				&			&\MC{9}{c}{\It{number}}	\\
\It{tense/}			&			&\MC{3}{c}{\SGs}					&\MC{3}{c}{\DUs}					&\MC{3}{c}{\PLs}	\\%\hline
...
%PRESENT
\PRSs	&1\superS{st}	&wk			&V			&		&str			&i			&\CH	&str			&V			&	\\%\cline{3-11}
				&2\superS{nd}	&wk			&V			&		&str			&V			&		&str			&V			&	\\%\cline{3-11}
				&3\superS{rd}	&str			&a			&		&str			&V			&		&str			&e			&\CH	\\%\cline{3-8}
%PAST
\PSTs	&1\superS{st}	&str			&i			&\CH	&wk			&V			&		&wk			&V			&	\\%\cline{3-11}
				&2\superS{nd}	&str			&e			&\CH	&wk			&V			&		&wk			&i			&	\\%\cline{3-11}
				&3\superS{rd}	&wk			&V			&		&wk			&V			&		&str			&i			&\CH	\\%\cline{3-8}
%%IMPERATIVE
\IMPs			&2\superS{nd}	&wk			&V			&		&str			&e			&		&str			&i			&\CH	\\\hline%\cline{3-8}
&&&&\\
\MC{8}{l}{\It{non-finite verb forms:}}\\\hline
\MC{2}{r}{\INFs}				&str			&V			&		&\MC{3}{r}{\CONNEGs}				&wk			&V			&	\\%\cline{2-8}
...
\It{mood}			&\It{person}	&\MC{1}{c}{\SGs}	&\MC{1}{c}{\DUs}		&\Xp{\PLs}	\\\hline
%PRESENT
\PRSs	&1\superS{st}	&bas-á-v	&biss-i-n			&\Xp{bass-e-p}		\\%\cline{3-5}
				&2\superS{nd}	&bas-á	&bass-e-bähten	&\Xp{bass-e-bähtet}	\\%\cline{3-5}
				&3\superS{rd}	&bass-a	&bass-e-ba		&\Xp{biss-e}		\\%\cline{2-5}
%PAST
\PSTs	&1\superS{st}	&biss-i-v	&bis-i-jmen		&\Xp{bis-i-jmä}		\\%\cline{3-5}
				&2\superS{nd}	&biss-e	&bis-i-jden		&\Xp{bis-i-jdä}		\\%\cline{3-5}
				&3\superS{rd}	&bis-i-j	&bis-i-jga			&\Xp{biss-i-n}		\\%\cline{2-5}
%IMPERATIVE
\IMPs			&2\superS{nd}	&bas-e	&bass-e-n			&\Xp{biss-i-t}		\\\hline%%\cline{3-5}
&&&&\\
\MC{5}{l}{\It{non-finite verb forms:}}\\\hline
\MC{1}{c}{\INFs}	&\MC{2}{c}{bass-e-t}	&\MC{1}{c}{\CONNEGs}&bas-e			\\
\MC{1}{c}{\PRFs}	&\MC{2}{c}{bass-a-m}	&\MC{2}{c}{}\\\hline%\cline{1-3}
\end{tabular}}
\end{table}
...
\It{mood}			&\It{person}	&\MC{1}{c}{\It{C-grad}}&\MC{1}{c}{\It{cl.\,sx.}}&\It{VH}&\MC{1}{c}{\It{C-grad}}&\MC{1}{c}{\It{cl.\,sx.}}&\It{VH}&\MC{1}{c}{\It{C-grad}}&\MC{1}{c}{\It{cl.\,sx.}}	&\It{VH}	\\\cline{1-11}%\cline{1-8}
%PRESENT
\PRSs	&1\superS{st}	&wk			&a/á			&		&str			&i			&\CH	&str			&e			&	\\%\cline{3-11}
				&2\superS{nd}	&wk			&a/á			&		&str			&e			&		&str			&e			&	\\%\cline{3-11}
				&3\superS{rd}	&str			&a			&		&str			&e			&		&str			&e			&\CH	\\%\cline{3-8}
%PAST
\PSTs	&1\superS{st}	&str			&i			&\CH	&wk			&i			&\CH	&wk			&i			&\CH	\\%\cline{3-11}
				&2\superS{nd}	&str			&e			&\CH	&wk			&i			&\CH	&wk			&i			&\CH	\\%\cline{3-11}
				&3\superS{rd}	&wk			&i			&\CH	&wk			&i			&\CH	&str			&i			&\CH	\\%\cline{3-8}
%%IMPERATIVE
...
\begin{tabular}{ccx{80pt}x{80pt}p{80pt}}
\It{tense/}			&			&\MC{3}{c}{\It{number}}	\\
\It{mood}			&\It{person}	&\SGs		&\DUs			&\Xp{\PLs}	\\\hline
%PRESENT
\PRSs	&1\superS{st}	&välld-u-v			&välld-u-jin		&\Xp{välld-u-p}		\\%\cline{3-5}
%\PRSs	&1\superS{st}	&välld-u-v			&\TabGray vällduj-i-n	&\Xp{välld-u-p}		\\%\cline{3-5}
				&2\superS{nd}	&välld-u			&välld-u-bähten		&\Xp{välld-u-bähtet}	\\%\cline{3-5}
				&3\superS{rd}	&välld-u-ja		&välld-u-ba		&\Xp{välld-u-je}		\\%\cline{2-5}
%				&3\superS{rd}	&\TabGray vällduj-a-	&välld-u-bah		&\Xp{\TabGray vällduj-e-}		\\\hline%\cline{2-5}
%PAST
\PSTs	&1\superS{st}	&välld-u-jiv		&välld-u-jmen		&\Xp{välld-u-jme}	\\%\cline{3-5}
				&2\superS{nd}	&välld-u-je		&välld-u-jden		&\Xp{välld-u-jde}		\\%\cline{3-5}
				&3\superS{rd}	&välld-u-j			&välld-u-jga		&\Xp{välld-u-jin}		\\%\cline{2-5}
%\PSTs	&1\superS{st}	&\TabGray vällduj-i-v	&välld-u-jmin		&\Xp{välld-u-jmä}	\\%\cline{3-5}
%				&2\superS{nd}	&\TabGray vällduj-e-	&välld-u-jdin		&\Xp{välld-u-jdä}		\\%\cline{3-5}
%				&3\superS{rd}	&välld-u-j			&välld-u-jgah		&\Xp{\TabGray vällduj-i-n}		\\\hline%\cline{2-5}
%IMPERATIVE
\IMPs			&2\superS{nd}	&n/a		&n/a			&\Xp{n/a}		\\\hline%%\cline{3-5}
&&&&\\
\MC{5}{l}{\It{non-finite verb forms:}}\\\hline
\MC{1}{c}{\INFs}	&\MC{2}{c}{välld-u-t}		&\MC{1}{c}{\CONNEGs}&välld-u				\\
\MC{1}{c}{\PRFs}	&\MC{2}{c}{välld-u-m}	&\MC{2}{c}{}\\\hline%\cline{1-3}
\end{tabular}}
\end{table}
...
\begin{tabular}{cc cc cc cc}
				&			&\MC{6}{c}{\It{number}}	\\
				&			&\MC{2}{c}{\SGs}			&\MC{2}{c}{\DUs}			&\MC{2}{c}{\PLs}	\\%\hline
...
%PRESENT
\PRSs	&1\superS{st}	&V			&			&V			&\CH		&V			&		\\%\cline{3-8}
				&2\superS{nd}	&V			&			&V			&			&V			&		\\%\cline{3-8}
				&3\superS{rd}	&V			&\CH		&V			&			&V			&\CH	\\%%\cline{3-8}
%PAST
\PSTs	&1\superS{st}	&V			&\CH		&V			&			&V			&		\\%\cline{3-8}
				&2\superS{nd}	&V			&\CH		&V			&			&V			&		\\%\cline{3-8}
				&3\superS{rd}	&V			&			&V			&			&V			&\CH	\\%%\cline{3-8}
%%IMPERATIVE
\IMPs			&2\superS{nd}	&n/a			&n/a			&n/a			&n/a			&n/a			&n/a		\\\hline%%\cline{3-8}
&&&&\\
\MC{8}{l}{\It{non-finite verb forms:}}\\\hline
\MC{2}{r}{\INFs}				&V			&			&\MC{2}{r}{\CONNEGs}		&V			&		\\%\cline{2-8}
...
\It{mood}			&\It{person}	&\SGs		&\DUs			&\Xp{\PLs}		\\\hline
%PRESENT
\PRSs	&1\superS{st}	&ságast-a-v	&ságast-e-n		&\Xp{ságast-e-p}	\\%\cline{3-5}
				&2\superS{nd}	&ságast-a		&ságast-ä-hpen	&\Xp{ságast-e-hpit}	\\%\cline{3-5}
				&3\superS{rd}	&ságast-a		&ságast-ä-ba		&\Xp{ságast-e}		\\%\cline{2-5}
%PAST
\PSTs	&1\superS{st}	&ságast-i-jiv	&ságast-i-jmen		&\Xp{ságast-i-jme}	\\%\cline{3-5}
				&2\superS{nd}	&ságast-i-je	&ságast-i-jden		&\Xp{ságast-i-jde}	\\%\cline{3-5}
				&3\superS{rd}	&ságast-i-j	&ságast-i-jga		&\Xp{ságast-e-n}	\\%\cline{2-5}
%IMPERATIVE
\IMPs			&2\superS{nd}	&ságast-e		&ságast-ä-hten		&\Xp{ságast-ä-htet}	\\\hline%%\cline{3-5}
&&&&\\
\MC{5}{l}{\It{non-finite verb forms:}}\\\hline
\MC{1}{c}{\INFs}	&\MC{2}{c}{ságast-i-t}		&\MC{1}{c}{\CONNEGs}&ságast-e		\\
\MC{1}{c}{\PRFs}	&\MC{2}{c}{ságast-a-m}	&\MC{2}{c}{}\\\hline%\cline{1-3}
\end{tabular}}
\end{table}
...
\begin{tabular}{cc x{60pt} x{60pt} c}
				&			&\MC{3}{c}{\It{number}}	\\
\It{tense/}			&			&\MC{1}{c}{\SGs}	&\MC{1}{c}{\DUs}	&\MC{1}{c}{\PLs}	\\%\hline
\It{mood}			&\It{person}	&\It{cl.\,sx.}		&\It{cl.\,sx.}		&\Xp{\It{cl.\,sx.}}	\\\cline{1-5}%\cline{1-8}
%PRESENT
\PRSs	&1\superS{st}	&a			&e			&\Xp{e}		\\%\cline{3-5}
				&2\superS{nd}	&a			&ä			&\Xp{e}		\\%\cline{3-5}
				&3\superS{rd}	&a			&ä			&\Xp{e}		\\%\cline{3-8}
%PAST
\PSTs	&1\superS{st}	&i			&i			&\Xp{i}		\\%\cline{3-5}
				&2\superS{nd}	&i			&i			&\Xp{i}		\\%\cline{3-5}
				&3\superS{rd}	&i			&i			&\Xp{e}		\\%\cline{3-8}
%%IMPERATIVE
\IMPs			&2\superS{nd}	&e			&ä			&\Xp{ä}		\\\hline%\cline{3-8}
&&&&\\
\MC{5}{l}{\It{non-finite verb forms:}}\\\hline
\MC{2}{r}{\INFs}				&i			&\MC{1}{r}{\CONNEGs}		&\Xp{e}		\\%\cline{2-8}
\MC{2}{r}{\PRFs}				&a			&\MC{2}{c}{}		\\\hline%\cline{1-3}
\end{tabular}
\end{table}
%\clearpage
\FB
...
\It{mood}			&\It{person}	&\MC{1}{c}{\SGs}	&\MC{1}{c}{\DUs}		&\Xp{\PLs}	\\\hline
%PRESENT
\PRSs	&1\superS{st}	&lev		&lin				&\Xp{lep}		\\%\cline{3-5}
				&2\superS{nd}	&lä/’l	&lähpen			&\Xp{lehpet}	\\%\cline{3-5}
				&3\superS{rd}	&lä/’l	&lähpa			&\Xp{lea/’l}		\\%\cline{2-5}
%PAST
\PSTs	&1\superS{st}	&lidjiv	&lijmen			&\Xp{lijme}	\\%\cline{3-5}
				&2\superS{nd}	&lidje	&lijden			&\Xp{lijde}		\\%\cline{3-5}
				&3\superS{rd}	&lij		&lijga			&\Xp{lidjen}		\\%\cline{2-5}
%IMPERATIVE
\IMPs			&2\superS{nd}	&n/a		&n/a				&\Xp{n/a}		\\\hline%%\cline{3-5}
&&&&\\
\MC{5}{l}{\It{other nonfinite verb forms:}}\\\hline
\MC{1}{c}{\INFs}	&\MC{2}{c}{årrot}			&\MC{1}{c}{\CONNEGs}&lä			\\
\MC{1}{c}{\PRFs}	&\MC{2}{c}{urrum/lam}		&\MC{2}{c}{}			\\\hline%\cline{1-3}%\hline
\end{tabular}}
\end{table}
...
\It{mood}			&\It{person}	&\SGs	&\DUs		&\Xp{\PLs}	\\\hline
%PRESENT
\PRSs	&1\superS{st}	&iv		&en			&\Xp{ep}		\\%\cline{3-5}
				&2\superS{nd}	&i		&ehpen		&\Xp{ehpet}	\\%\cline{3-5}
				&3\superS{rd}	&ij		&eba			&\Xp{eh}		\\%\cline{2-5}
%PAST
\PSTs	&1\superS{st}	&ittjiv	&ettjijmen		&\Xp{ittjijme}	\\%\cline{3-5}
				&2\superS{nd}	&ittje		&ettjijden		&\Xp{ittjijde}	\\%\cline{3-5}
				&3\superS{rd}	&ittjij		&ettjijga		&\Xp{ittjin}		\\%\cline{2-5}
%IMPERATIVE
...
I	&		&viess-o-t		&vies-o		&viess-o		&viess-o		&vies-o-j		&vies-o		& ‘live, feel’	\\%\cline{3-9}%\hline
	...
	&		&gårr-o-t		&går-o		&gårr-o		&gårr-o		&går-o-j		&går-o		& ‘sew’	\\%%\cline{3-9}%\hline\hline
II	&a		&tjájbm-a-t	&tjájm-a		&tjájbm-a		&tjijbm-e		&tjájm-a-j		&tjájm-a		& ‘laugh’	\\%\cline{3-9}%%\hline
	...
	&b		&bårr-å-t		&bår-å		&bårr-a		&burr-e		&bår-å-j		&bår-å		& ‘eat’		\\%\hline
...
III	&		&bass-e-t		&bas-á		&bass-a		&biss-e		&bis-i-j		&bas-e		& ‘fry’		\\%\cline{3-9}%%\hline
	...
	&		&vádts-e-t		&váts-a		&vádts-a		&vädts-e		&väts-i-j		&váts-e		& ‘go’		\\%\hline

IV	&		&välld-u-t		&välld-u		&välld-u-ja	&välld-u-je	&välld-u-j		&välld-u		& ‘marry’		\\%\hline
%	&		&årr-a-t		&årr-a		&årr-aj		&år-aj-e		&år-aji-j		&?			& ‘fall asleep’		\\%\hline
...
V	&		&ságast-i-t	&ságast-a		&ságast-a		&ságast-e		&ságast-i-j	&ságast-e		& ‘say’		\\%\cline{3-9}%%\hline
	...
	&		&bargatj-i-t	&bargatj-a		&bargatj-a		&bargatj-e		&bargatj-i-j	&bargatj-e		& ‘work a little’	\\%\hline%JW: corrected gloss AFTER final version sent in -- Jan 2013!!!

\MC{2}{l}{copula}&årrot		&lä			&lä			&lidje		&lij			&lä			& ‘be	’	\\%\hline
