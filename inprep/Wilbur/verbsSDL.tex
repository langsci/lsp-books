...
The verb \It{årrot} ‘be’ can be used as a copula (cf. \SEC\ref{copulaClauses}) or as an \is{verb!auxiliary}auxiliary (cf. \SEC\ref{auxV}); its paradigm is presented in Table~\vref{beParadigm}. %on page \pageref{beParadigm}. 
\renewcommand{\Xp}[1]{\MC{1}{x{80pt}}{#1}}%JW: added to allow centering in final set-length column in verb paradigm tables; redefined here
\begin{table}[h]\centering
