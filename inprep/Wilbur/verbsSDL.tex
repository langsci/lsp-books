...
The verb \It{bassat} ‘wash’ is provided in Table \vref{washParadigm} as an example for a Class IIa verb, and \It{bårråt} ‘eat’ for a Class IIb verb in Table \ref{eatParadigm} on the same page. 
\begin{table}\centering
