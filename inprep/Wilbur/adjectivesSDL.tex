...
\Bf{Adjectivals} in \PS\ are defined syntactically by their ability to head an adjectival phrase (AP). They can be divided into four sub-categories based on both syntactic and morphological behavior, as summarized in Table \vref{adjectivalsSummary}.
...
The rest of this chapter covers adjectives, demonstratives and numerals as follows: Section \ref{adjectivesATTR} provides a description of attributive adjectives, %(\ref{ADJinHeadlessNPs}) describes adjectives in headless NPs, 
...
Finally, Section \ref{numerals} covers numerals. %, which essentially function like other adjective and predicate adjective forms. %are morphosyntactically like other adjectives and predicate adjective forms, but semantically like numerals in that they quantify the referents of the nouns they modify. 
...
\Bf{Attributive adjectives} form the head of an AP modifying the head of the matrix nominal phrase, and are normally not subject to inflectional morphology. 
...
\glll	ja dat lä årrom hoj buorak giesse\\
	...
	and \Sc{dem}-\Sc{dist}-\Sc{nom.sg} be\BS\Sc{3sg.prs} be-\Sc{prf} very good summer\BS\Sc{nom.sg}\\\nopagebreak
...
%attr +s, pred +t
\MR{2}{*}{\It{i}}
	&tjähpis	&tjáhpat		&tjáhpada		&IIIa	& ‘black’	\\\cline{2-6}%\hline
	&rusjgis	&russjgat		&russjgada	&IIIa	& ‘red’	\\\dline%\cline{2-6}%\hline
%attr=pred.pl+s
\MR{4}{*}{\It{ii}}%\MR{4}{*}{\ATTRs=\PREDs.\PLs+s}
	&nievres	&nävvre		&nievre		&Ie	& ‘bad’	\\\cline{2-6}%\hline
	&vastes	&vasste		&vaste		&Ie	& ‘ugly’	\\\cline{2-6}%\hline
	&buosjes	&buossje		&buosje		&Ie	& ‘fearless’	\\\cline{2-6}%\hline
	&fávros	&fávvro		&fávro		&Ic	& ‘attractive’	\\\dline
%attr=pred.sg, both +s
\MR{6}{*}{\It{iii}}%\MR{6}{*}{\ATTRs=\PREDs.\SGs (-s)}
	&dájges	&dájges		&dájgesa		&IIIa	& ‘cowardly’	\\\cline{2-6}%\hline
	&åvros	&åvros		&åvrosa		&IIIa	& ‘nervous’	\\\cline{2-6}%\hline
	&vuoras	&vuoras		&vuorasa		&IIIa	& ‘old’	\\\cline{2-6}%\hline
	
	&gujos	&gujos		&gudjosa		&IIIa	& ‘frozen solid’	\\\cline{2-6}%\hline
	&luvas	&luvas		&luvvasa		&IIIa	& ‘wet’	\\\cline{2-6}%\hline
	&nanos	&nanos		&nannosa		&IIIa	& ‘sturdy’	\\\dline
%attr=pred.sg, pred.pl -s
\MR{1}{*}{\It{iv}}%\parbox{100pt}{\ATTRs=\PREDs.\SGs (-s); \PREDs.\PL\ w/o -s}
	&sádnes	&sádnes		&sádna		&II	& ‘true’	\\\dline%\cline{2-6}%\hline
%pred.sg+is
\MR{2}{*}{\It{v}}%\MR{2}{*}{\ATTRs=\PREDs.\SGs+s}
	&bivvalis	&bivval		&bivvala		&IIIa	& ‘warm’ (weather)	\\\cline{2-6}%\hline
	&buoragis	&buorak		&buoraga		&IIIa	& ‘good’	\\\dline%\cline{2-6}%\hline
%attr=pred.pl +g+s
\MR{1}{*}{\It{vi}}%
	&ånegis	&ådne		&åne			&Ie	& ‘short’	\\\dline%\cline{2-6}%\hline
%pred +t
\MR{4}{*}{\It{vii}}%
	&jallga	&jallgat		&jallgada		&IIIa	& ‘flat’	\\\cline{2-6}%\hline
	&njuallga	&njuallgat		&njuallgada	&IIIa	& ‘straight’	\\\cline{2-6}%\hline
%attr=pred.pl -s
%\MR{2}{*}{\It{viii}%
	&lägga	&lieggas		&läggasa		&IIIa	& ‘warm’	\\\cline{2-6}%\hline
...
\MR{4}{*}{\It{viii}}
	&tjábba	&tjábbe		& ‘beautiful’	\\\cline{2-4}%\hline
	&guhka	&guhke		& ‘long’		\\\cline{2-4}%\hline
	&unna	&unne 		& ‘small’ (only \SGs)	\\\cline{2-4}%\hline
	&smáva	&smáve		& ‘small’ (only \PLs)	\\\dline
\MR{5}{*}{\It{ix}}
	&tjåskes	&tjåskes		& ‘cold’ (weather)	\\\cline{2-4}%\hline
	&låjes	&låjes		& ‘tame’	\\\cline{2-4}%\hline
%\MR{3}{*}{\It{x}
	&gårå	&gårå		& ‘bad’	\\\cline{2-4}%\hline
	&räkta	&räkta		& ‘correct’	\\\cline{2-4}%\hline
...
\MR{2}{*}{\It{iii}}
	&luvas		&luvasu-p		&-o			&luvasu-\It{mos}	&-\It{bmus}-a	& ‘wet’	\\\cline{2-7}%\hline
	&garras		&garrasu-p	&-o			&garrasu-\It{mos}	&-\It{bmus}-a	& ‘hard’	\\\dline%\cline{2-7}%\hline
%låjes			&låjes-u-p		&-o			&låjes-u-mos		&-musa	& ‘tame’	\\\cline{2-7}%\hline%JW: DS provides conflicting data!
\MR{6}{*}{\It{iv}}
	&nanos		&nanosu-p	&-a			&nanosu-\It{mos}	&-\It{bmus}-a	& ‘strong’	\\\cline{2-7}%\hline
	&bivval		&bivvalu-p		&-a			&bivvalu-\It{mos}	&-\It{bmus}-a	& ‘warm’	\\\cline{2-7}%\hline
	&tjáhpat		&tjáhpadu-p	&-a			&tjáhpadu-\It{mos}	&-\It{bmus}-a	& ‘black’	\\\cline{2-7}%\hline
	&galmas		&galbmasu-p	&-a			&galbmasu-\It{mos}	&-\It{bmus}-a	& ‘cold’	\\\cline{2-7}%\hline
	&vuoras		&vuorasu-p	&-a			&vuorasu-\It{mos}	&-\It{bmus}-a	& ‘old’	\\\cline{2-7}%\hline
...
Examples for C/S adjectives in attributive position can be found in \REF{compATTRADJex1} and \REF{superlATTRADJex1}, respectively. Instances for predicative usage can be found in \REF{comparingNPsEx3} and \REF{comparingNPsEx5} in Section \ref{comparingNPs}.
...
\MC{1}{c|}{}&\It{cardinal}&&\It{ordinal}	&\MC{1}{c}{} \\\cline{1-2}\cline{4-5}%\cline{1-2}\cline{4-5}%\dline
...
1000	&tuvsan		&&?			&1000\superS{th}	\\\cline{1-2}\cline{4-5}%\hline
\end{tabular}
\end{table}
