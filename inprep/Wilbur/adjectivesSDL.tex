...
However, as \It{njalga} ‘tasty’ in \REF{adjEx2} illustrates, not all adjectives are marked this way. Furthermore, corresponding predicate adjective forms (cf. \SEC\ref{predADJ} below) often also have a final \It{-s}, sometimes even to the exclusion of the attributive adjective form. Because no consistent relationship between forms with and forms without a final \It{-s} exists, it is no longer a productive way to mark or derive either attributive or predicative adjectives, and is not considered to be morphologically meaningful in the present discussion. Nonetheless, it is worth nothing that adjectival forms (both attributive and predicative) ending in \It{-s} are common. 
...
it seems that this syntactic restriction was also borrowed. While a few examples exist in the corpus of \It{unn-} modifying a plural noun, \It{smáv-} is the preferred item and much more frequent in the corpus.%
...
22	&guäkte-låg-\Bf{guäkte}	&\ARROW&22\superS{nd}	&guäkte-låg-\Bf{guoktát}\\\dline
