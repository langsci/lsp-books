...
%\includeonly{syntaxSentencesSDL}%this has only the documents listed printed/TeXed, but all refs, page nos. etc. are accurate (assuming .aux files for ALL included documents already exist. syntax: \includeonly{firstfile,secondfile,fifthfile}
